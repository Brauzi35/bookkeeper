 ...
 */
public class BookieImplSetup extends BookieImpl {
    private static final Logger log = LoggerFactory.getLogger(BookieImplSetup.class);

    private final Resources resources;

    public BookieImplSetup(ServerConfiguration conf) throws Exception {
        this(new ResourceBuilder(conf).build());
    }

    public BookieImplSetup(Resources resources, StatsLogger statsLogger) throws Exception {
    ...
    public BookieImplSetup(Resources resources) throws Exception {
        super(resources.conf,
                resources.registrationManager,
                resources.storage,
                resources.diskChecker,
